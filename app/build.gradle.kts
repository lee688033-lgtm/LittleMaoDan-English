...
android { namespace = "com.example.cet6vocabulary"; compileSdk = 35
    ...
    defaultConfig { applicationId = "com.example.cet6vocabulary"; minSdk = 24; targetSdk = 35; versionCode = 1; versionName = "1.0"; testInstrumentationRunner = "com.example.cet6vocabulary.data.PersistenceInstrumentation" }
}
